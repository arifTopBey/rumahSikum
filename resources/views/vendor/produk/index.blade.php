...
<div class="container-fluid px-5 bg-light pb-5">
    <div class="row pt-5 mb-4">
        <div class="col-md-12 d-flex justify-content-between align-items-end">
            <div>
                <h4 class="fw-800 text-primary mb-1">Katalog Produk Saya</h4>
                <p class="text-muted small mb-0">Kelola stok dan pantau performa penjualan produk Anda di sini.</p>
            </div>
            ...
            <table class="table table-hover align-middle mb-0">
                <thead class="bg-primary bg-opacity-10">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-primary smaller text-uppercase fw-800 text-end">Kelola</th>
                    </tr>
                </thead>
                    ...
                    <tr>
                        ...
                        <td class="px-4 text-end">
                            <div class="btn-group shadow-sm rounded-3 overflow-hidden">
                                <a href="{{ route('vendor.produk.show', $produk->id) }}" class="btn btn-white btn-sm border-end" title="Lihat Detail">
