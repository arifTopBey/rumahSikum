            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm rounded-4 p-4 bg-white mb-4">
                    ...
                    <div class="d-flex gap-3 mb-4">
                        <div style="background-color: rgba(168, 34, 130, 0.3); color: #a82282;" class=" p-3 rounded-4 d-flex align-items-center justify-content-center" style="width: 55px; height: 55px;">
