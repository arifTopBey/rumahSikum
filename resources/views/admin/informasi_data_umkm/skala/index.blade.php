                ...
                @foreach ($data as $umkm)
                    <tr>
                        ...
                        <td class="text-center">
                            @if ($umkm->produksiDanPemasaran->produksi_sendiri <= 2_000_000_000)
                                <div
                            ...
                            @elseif($umkm->produksiDanPemasaran->produksi_sendiri > 2_000_000_000 && $umkm->produksiDanPemasaran->produksi_sendiri < 15_000_000_000)
                                <div
                            ...
                            @elseif ($umkm->produksiDanPemasaran->produksi_sendiri >= 15_000_000_000)
                                <div
