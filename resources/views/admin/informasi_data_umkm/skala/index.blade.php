                ...
                @foreach ($data as $umkm)
                    <tr>
                        ...
                        <td class="text-center">
                            @if ($umkm->omzet_usaha <= 2000000000)
                                <div
                            ...
                            @elseif($umkm->omzet_usaha > 2000000000 && $umkm->omzet_usaha <= 15000000000)
                                <div
                            ...
                            @elseif ($umkm->omzet_usaha > 15_000_000_000 && $umkm->omzet_usaha <= 50000000000)
                                <div
