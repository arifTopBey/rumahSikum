    ...
    <form action="{{ route('admin.kupon.store') }}" method="POST">
        ...
        <div class="row py-5">
            <div class="col-md-12 d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="fw-800 text-primary mb-1">Buat Kupon Voucher Baru</h4>
                    <p class="text-muted small mb-0">Tambahkan promo potongan harga untuk meningkatkan penjualan e-commerce UMKM.</p>
                </div>
                <div class="d-flex gap-2">
                    <a href="{{ route('admin.kupon.index') }}" class="btn btn-light rounded-pill px-4 fw-bold border">Batal</a>
                    <button type="submit" class="btn btn-primary rounded-pill px-4 fw-bold shadow">Simpan & Aktifkan</button>
                </div>
            </div>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_kupon" class="form-control form-control-lg rounded-3 border-2" placeholder="Contoh: Promo Ramadhan Berkah" value="{{ old('nama_kupon') }}" required>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" id="code_kupon" name="code_kupon" class="form-control border-2 text-uppercase rounded-start-3 fw-bold" placeholder="Contoh: RAMADHAN25" value="{{ old('code_kupon') }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="diskon_value" class="form-control border-2 rounded-end-3" placeholder="Contoh: 25000" value="{{ old('diskon_value') }}" min="1" required>
                            </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 p-4 bg-white">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" name="max_use" class="form-control border-2 rounded-start-3" placeholder="Contoh: 100" value="{{ old('max_use') }}" min="1" required>
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4 bg-white">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tanggal_mulai" class="form-control rounded-3 border-2" value="{{ old('tanggal_mulai', date('Y-m-d')) }}" required>
                    </div>

                    <div class="mb-0">
                        <label class="form-label small fw-bold text-muted">Tanggal Berakhir</label>
                        <input type="date" name="tanggal_berakhir" class="form-control rounded-3 border-2" value="{{ old('tanggal_berakhir') }}" required>
                    </div>
                </div>

                <div class="card border-0 shadow-sm rounded-4 p-4 bg-primary bg-opacity-10 border border-primary border-opacity-25">
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" name="status_kupon" value="1" id="statusKupon" checked>
...
<script>
    ...
    // Logika Otomatis Membuat Acak Kode Voucher
    document.getElementById('btn-generate').addEventListener('click', function() {
        const characters = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789';
        let result = 'PROMO';
        const charactersLength = characters.length;
        
        // Membuat 6 karakter acak di belakang kata 'PROMO'
        for (let i = 0; i < 6; i++) {
