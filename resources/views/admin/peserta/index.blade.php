            ...
            <div class="table-responsive">
                <table class="table table-borderless align-middle mb-0">
                    ...
                    <tr class="border-bottom">
                        <td class="px-3 py-3">
                            <div class="fw-bold text-dark mb-1">{{ $e->judul_event }}</div>
                            <div class="d-flex gap-1">
                                <span class="badge rounded-pill px-2 py-0.5 smaller fw-medium" style="background-color: #e0e7ff; color: #4338ca;">
                                    <i data-lucide="monitor" size="10" class="me-0.5"></i> {{ $e->jenis_pelatihan }}
                                </span>
                                <!-- <span class="badge rounded-pill px-2 py-0.5 smaller fw-medium" style="background-color: #fee2e2; color: #dc2626;">Dibatalkan</span> -->
                            </div>
                        </td>
                        <td class="px-3 text-secondary fw-normal">{{ \Carbon\Carbon::parse($e->waktu_mulai)->format('d M Y') }}</td>
                        <td class="px-3 text-center fw-bold text-dark">{{ $e->peserta->count() }}</td>
                        <td class="px-3 text-center fw-bold text-dark">0</td>
                        <!-- <td class="px-3 text-center fw-bold text-dark">{{ $e->materi->count() }}</td> -->
                        ...
                        <td class="px-3 text-center text-secondary">
                            <i data-lucide="folder" size="15" class="text-muted opacity-50 me-1"></i> {{ $e->materi->count() }}
                        </td>
                        <td class="px-3 text-center">
