        ...
        <div class="row py-5">
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                    <div class="mb-4">
                        <label class="form-label fw-bold text-dark">Nama / Judul Acara</label>
                    ...
                    <div class="mb-0">
                        <label class="form-label fw-bold text-dark">Deskripsi & Detail Acara</label>
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="lokasi" class="form-control rounded-3" rows="2" placeholder="Lokasi Tempat acara"></textarea>
                    </div>
                    <div class="mb-0">
