        ...
        <div class="row py-5">
            <div
                ...
                <div>
                    ...
                    <p class="text-muted mb-0">Tambahkan atau ubah kategori E-learning dengan cepat di sini.</p>
                </div>
    ...
    <div class="modal fade" id="modalTambahKategori" tabindex="-1" aria-labelledby="modalTambahKategoriLabel"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 rounded-4 shadow-lg">
                ...
                <form id="formKategori" action="{{ route('admin.kategori.elearning.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="modal-body p-4">
                        <div class="mb-3">
                            ...
                            <input type="text" id="cat_name" name="name" class="form-control rounded-3"
                                placeholder="Contoh: UMKM" required autofocus>
                        </div>
                        <div class="mb-0">
