...
<div class="container-fluid py-4" style="background-color: #f8f9fa;">
    ...
    <div id="kukTableContainer" class="card border-0 p-4 mt-4 shadow-sm d-none" style="border-radius: 12px; background: white;">
        ...
        <div class="d-flex gap-2">
            <form action="{{ route('koperasi.exportExcelKuk') }}" method="POST" id="formExportKuk">
                @csrf
                <input type="hidden" name="kuk" id="exportKukLevel">
...
<script>
    ...
    // SALIN PARAMETER TINGKAT KUK KE DALAM INPUT ELEMEN FORM EXPORT
    document.getElementById('exportKukLevel').value = kukLevel;
