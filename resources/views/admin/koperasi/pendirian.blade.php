        ...
        <div class="col-lg-4">
            <div class="card border-0 p-3 h-100" style="border-radius: 12px; background: white;">
                ...
                <div class="d-flex justify-content-center gap-3 mt-3" style="font-size: 0.75rem;">
                    <div><span class="badge rounded-circle p-1 me-1" style="background-color: #4f46e5;">&nbsp;</span> Pengesahan AHU (582)</div>
                    <div><span class="badge rounded-circle p-1 me-1" style="background-color: #f97316;">&nbsp;</span> Pengesahan Lainnya (366)</div>
                </div>
            </div>
        </div>
