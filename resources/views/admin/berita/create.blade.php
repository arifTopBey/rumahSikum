            ...
            <div class="row py-5">
                ...
                <div class="col-lg-8">
                    <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                        <div class="mb-4">
                            ...
                            <input type="text" name="judul" class="form-control form-control-lg rounded-3 border-2"
                ...
                <div class="col-lg-4">
                    <div class="card border-0 shadow-sm rounded-4 p-4 mb-4 text-center">
                        ...
                        <!-- Preview -->
                        <img id="preview-gambar" src="" class="img-fluid rounded-3 mb-2 d-none"
                        ...
                        <div class="border border-2 border-dashed rounded-4 p-4 mb-2" id="drop-area">
                            ...
                            <i data-lucide="image" size="48" class="text-muted mb-2"></i>
                            <p class="smaller text-muted mb-2">Seret gambar ke sini atau klik untuk unggah</p>
                            <input type="file"   id="thumbnail"  name="gambar" id="thumbnail" class="form-control form-control-sm"
                                accept="image/*">
                        </div>
