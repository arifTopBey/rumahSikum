        ...
        <div class="row py-5">
            ...
            <div class="col-md-12">
                <div class="row d-flex justify-content-end mb-3">
                    <div class="col-md-4">
                        <form action="{{ route('admin.ukmkm.list') }}" method="GET">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Cari berdasarkan nama usaha, kecamatan, atau nomor telepon"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @elseif( $umkm->laporanKeuangan->omzet_usaha > 2000000 && $umkm->laporanKeuangan->omzet_usaha <= 15000000)
                                        <div
